          ...
          <ul class="section7_shoeContaienr">
            ...
            >
              ...
              >
                ...
                />
                <img src="/us-store/shoes/01shoes.png" alt="01shoes" />
              </div>
            </li>
            <li
              @click="
            ...
            >
              ...
              >
                <div
                  ...
                  width : ${innerHeight * 0.11}px`"
                />
                <img src="/us-store/shoes/02shoes.png" alt="02shoes" />
              </div>
            </li>
            <li
              @click="
            ...
            >
              ...
              >
                <div
                  ...
                  width : ${innerHeight * 0.11}px`"
                />
                <img src="/us-store/shoes/03shoes.png" alt="03shoes" />
              </div>
            </li>
            <li
              @click="
            ...
            >
              ...
              >
                <div
                  ...
                  width : ${innerHeight * 0.11}px`"
                />
                <img src="/us-store/shoes/04shoes.png" alt="04shoes" />
              </div>
            </li>
            <li
              @click="
            ...
            >
              ...
              >
                <div
                  ...
                  width : ${innerHeight * 0.11}px`"
                />
                <img src="/us-store/shoes/05shoes.png" alt="05shoes" />
              </div>
            </li>
          </ul>
        </div>
