    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <img src="/outlet/result/pop-up.png" />
          </div>
          <div
        ...
        >
          ...
          />
          <img :src="`/outlet/result/FN${this.output_color}.png`" />
        </div>
  ...
  methods: {
    ...
    shareButton() {
      ...
      switch (this.output_color) {
        case "pink":
          storylink = "/outlet/StoryDownloadSIZE/PINK_story.mp4";
          break;
        case "teal":
          storylink = "/outlet/StoryDownloadSIZE/GREEN_story.mp4";
          break;
        case "yellow":
          storylink = "/outlet/StoryDownloadSIZE/YELLOW_story.mp4";
          break;
        case "purple":
          storylink = "/outlet/StoryDownloadSIZE/PURPLE_story.mp4";
          break;
        case "cream":
          storylink = "/outlet/StoryDownloadSIZE/CHALK_story.mp4";
          break;
      }
